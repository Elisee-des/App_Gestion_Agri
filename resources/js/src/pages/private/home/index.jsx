                ...
                <div className="layout-rightside">
                    <div className="card h-100 rounded-0">
                        <div className="card-body p-0">
                            ...
                            <div data-simplebar className="p-3 pt-0">
                                <div className="acitivity-timeline acitivity-main">
                                    ...
                                    <div className="acitivity-item py-3 d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h6 className="mb-1 lh-base">
                                                Natasha Carey have liked the
                                                products
                                            </h6>
                                            <p className="text-muted mb-1">
                                                Allow users to like products in
                                    ...
                                    <div className="acitivity-item py-3 d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted mb-2">
                                                Offer is valid on orders of
                                                Rs.500 Or above for selected
                                                products only.
                                            </p>
                                            <small className="mb-0 text-muted">
                                                12 Dec, 2021
                                    ...
                                    <div className="acitivity-item d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            ...
                                            <p className="text-muted mb-2 fst-italic">
                                                " A product that has reviews is
                                                more likable to be sold than a
                                                product. "
                                            </p>
                                            <small className="mb-0 text-muted">
                                                26 Aug, 2021
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="text-muted lh-base">
                                            Refer a new seller to us and earn
                                            $100 per refer.
                                        </p>
                                        <button
                                            type="button"
