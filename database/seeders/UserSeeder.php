...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = [
            ...
            array('nom' => 'Zongo', 'prenom' => 'Herver', 'email' => 'herver@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'telephone' => '56346534', 'role' => 'CI', 'faitiere_id' => 1, 'remember_token' => Str::random(10)),
            array('nom' => 'Ouedraogo', 'prenom' => 'Adama', 'email' => 'adama@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('password'), 'telephone' => '76456576', 'role' => 'CI', 'faitiere_id' => 1, 'remember_token' => Str::random(10)),
